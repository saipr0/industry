class RetailersController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to retailers_path, status: :see_other, notice: "Retailer was successfully destroyed." }
  ...
  private
    ...
    def retailer_params
      params.expect(retailer: [ :retailerID, :name, :contactDetails, :location ])
    end
end
